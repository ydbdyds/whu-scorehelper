...
class Selenium:
    ...
    def sendmail(self,titile,msg):  #邮箱需开启stmp服务
        ...
        mailpsd = 'bwxsezcwzwqgbeif'   #授权码或密码
        ...
        smtp = smtplib.SMTP_SSL(mailhost)
        smtp.ehlo(mailhost)
    ...
    def login(self, username, password):
        ...
        time.sleep(0.2)
        self.driver.find_element_by_xpath('//*[@id="casLoginForm"]/p[2]/button').click()  # 登录按钮
        time.sleep(5)
...
if __name__ == '__main__':
    username = '2018326660093'  # 你的信息门户账号
    password = 'whu10486'  # 你的信息门户账号对应的密码
